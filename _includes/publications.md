...
The following papers were completed by my colleagues before I joined the PhD team. They collected <strong>scanpath data of children with autism spectrum disorder (ASD) using an eye tracker from our lab</strong>. I plan to use the data they collected and continue their work by conducting further scanpath research, which is why I have included these papers here.  Additionally, I will further explore <strong>how to better incorporate the <a href="https://connect.tobii.com/s/spectrum-get-started?language=en_US">Tobii Pro Spectrum eye tracker</a>, available in our lab, into my future work.</strong>
